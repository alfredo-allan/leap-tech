    ...
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001427] backdrop-blur-md z-50 px-10">
      ...
      <div className="w-full h-full flex items-center justify-between m-auto px-[10px]">
        ...
        <Link href="#about-me" className="flex items-center">
          <Image src="/logo-leap.png" alt="Logo" width={40} height={40} draggable={false} className="cursor-pointer" />
        ...
        {/* Hamburger Menu */}
        <button className="md:hidden text-white focus:outline-none text-4xl" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
          ☰
        </button>
      </div>
